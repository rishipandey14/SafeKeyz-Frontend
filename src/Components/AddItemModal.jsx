...
const AddItemModal = ({ isOpen, onClose, onItemAdded, preSelectedCategory }) => {
  ...
  const [selectedCategory, setSelectedCategory] = useState(
    preSelectedCategory || "userId-password"
  );
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div>
            ...
            <input
              ...
              placeholder="e.g., Gmail Account, PayPal Card"
              className="w-full bg-gray-50 text-gray-900 border-2 border-gray-300 px-4 py-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all"
            />
          </div>
            ...
            {fields.map((field) => (
              <div key={field}>
                ...
                <input
                  ...
                  className="w-full bg-white text-gray-900 border border-gray-300 px-3 py-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all text-sm"
                />
              </div>
            ))}
          </div>
